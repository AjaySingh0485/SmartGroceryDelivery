...
public class RuningAdapter extends RecyclerView.Adapter<RuningAdapter.MyViewHolder> {
    ...
    public RuningAdapter(List<Parameter> list, Context context, AdapterCallback callback
    ) {
        this.list = list;
    ...
    @Override
    public void onBindViewHolder(final RuningAdapter.MyViewHolder holder, final int position) {
