...
public class DelivredAdapter extends RecyclerView.Adapter<DelivredAdapter.MyViewHolder> {

    private List<Parameter> list;
    Context context;
    private DelivredAdapter.AdapterCallback mAdapterCallback;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView call_vender,direction_vender;
        public MyViewHolder(View view) {
            ...
            call_vender= view.findViewById(R.id.vender_call);
    ...
    public DelivredAdapter(List<Parameter> list, Context context, AdapterCallback callback
    ) {
        this.list = list;
    ...
    @Override
    public DelivredAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.deliverd_item, parent, false);

        return new DelivredAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final DelivredAdapter.MyViewHolder holder, final int position) {
        ...
        holder.img_expand_b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mAdapterCallback.onMethodCallback(list.get(position).getOrderId());
